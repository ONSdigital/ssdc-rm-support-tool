...
curl -X PUT http://$PUBSUB_SETUP_HOST/v1/projects/shared-project/subscriptions/event_survey-update_it -H 'Content-Type: application/json' -d '{"topic": "projects/shared-project/topics/event_survey-update"}'
