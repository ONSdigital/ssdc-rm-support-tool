...
public class ExceptionManagerEndpoint {
  ...
  public ResponseEntity<String> getBadMessagesSummary(
    ...
    userIdentity.checkGlobalUserPermission(userEmail, UserGroupAuthorisedActivityType.EXCEPTION_MANAGER_VIEWER);
  ...
  public ResponseEntity<String> peekMessage(
      @PathVariable("messageHash") String messageHash,
      @Value("#{request.getAttribute('userEmail')}") String userEmail) {
    userIdentity.checkGlobalUserPermission(userEmail, UserGroupAuthorisedActivityType.EXCEPTION_MANAGER_PEEK);
  ...
  public ResponseEntity<Void> skipMessage(
      @PathVariable("messageHash") String messageHash,
      @Value("#{request.getAttribute('userEmail')}") String userEmail) {
    userIdentity.checkGlobalUserPermission(userEmail, UserGroupAuthorisedActivityType.EXCEPTION_MANAGER_QUARANTINE);
