...
import uk.gov.ons.ssdc.supporttool.model.dto.messaging.ActionRuleSurveyPrintTemplateDTO;
...
public class ActionRuleSurveyPrintTemplateEndpoint {
  ...
  public ResponseEntity<String> createActionRuleSurveyPrintTemplate(
      @RequestBody ActionRuleSurveyPrintTemplateDTO actionRuleSurveyPrintTemplateDTO) {
    Survey survey =
        surveyRepository
            .findById(actionRuleSurveyPrintTemplateDTO.getSurveyId())
            .orElseThrow(
                () -> new ResponseStatusException(HttpStatus.BAD_REQUEST, "Survey not found"));

    PrintTemplate printTemplate =
        printTemplateRepository
            .findById(actionRuleSurveyPrintTemplateDTO.getPackCode())
            .orElseThrow(
                () ->
